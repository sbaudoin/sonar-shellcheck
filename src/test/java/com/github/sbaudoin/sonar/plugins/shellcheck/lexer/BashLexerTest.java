...
import static com.github.sbaudoin.sonar.plugins.shellcheck.lexer.TokenType.*;
...
public class BashLexerTest {
    ...
    public void testDefaultConstructor() throws IOException {
        List<Token> tokens = new BashLexer(new StringReader(Utils.getInputFile("test5.sh").contents())).scan();
        Assert.assertEquals(10, tokens.size());
        Assert.assertEquals(new Token(SHEBANG, 0, 12, 0, 0), tokens.get(0));
        Assert.assertEquals(new Token(LINE_FEED, 12, 1, 1, 0), tokens.get(1));
        Assert.assertEquals(new Token(WORD, 13, 4, 2, 0), tokens.get(2));
        Assert.assertEquals(new Token(WHITESPACE, 17, 1, 2, 4), tokens.get(3));
        Assert.assertEquals(new Token(STRING2, 18, 14, 2, 5), tokens.get(4));
        Assert.assertEquals(new Token(WHITESPACE, 32, 1, 2, 19), tokens.get(5));
        Assert.assertEquals(new Token(REDIRECT_AMP_GREATER_GREATER, 33, 3, 2, 20), tokens.get(6));
        Assert.assertEquals(new Token(WHITESPACE, 36, 1, 2, 23), tokens.get(7));
        Assert.assertEquals(new Token(WORD, 37, 7, 2, 24), tokens.get(8));
        Assert.assertEquals(new Token(LINE_FEED, 44, 1, 2, 31), tokens.get(9));
    }

    @Test
    public void testBash3() throws IOException {
        List<Token> tokens = new BashLexer(false, new StringReader(Utils.getInputFile("test5.sh").contents())).scan();
        ...
        Assert.assertEquals(new Token(STRING2, 18, 14, 2, 5), tokens.get(4));
        Assert.assertEquals(new Token(WHITESPACE, 32, 1, 2, 19), tokens.get(5));
        Assert.assertEquals(new Token(AMP, 33, 1, 2, 20), tokens.get(6));
        Assert.assertEquals(new Token(SHIFT_RIGHT, 34, 2, 2, 21), tokens.get(7));
        Assert.assertEquals(new Token(WHITESPACE, 36, 1, 2, 23), tokens.get(8));
        Assert.assertEquals(new Token(WORD, 37, 7, 2, 24), tokens.get(9));
        Assert.assertEquals(new Token(LINE_FEED, 44, 1, 2, 31), tokens.get(10));
    }

    @Test
    public void testInitialState() {
        BashLexer lexer = new BashLexer(BashVersion.Bash_v3, new StringReader("abc"));
        Assert.assertTrue(lexer.isInState(BashLexer.YYINITIAL));
    }
    ...
    @Test
    public void testSimpleDefTokenization() throws IOException {
    ...
    public void testVariables() throws IOException {
        ...
        testTokenization("[ $(uname -a) ]", EXPR_CONDITIONAL, DOLLAR, LEFT_PAREN, WORD, WHITESPACE, WORD, RIGHT_PAREN, EXPR_CONDITIONAL_END);
    }

    @Test
    public void testArrayVariables() throws IOException {
    ...
    @Test
    public void testSquareBracketArithmeticExpr() throws IOException {
        testTokenization("$[1]", DOLLAR, EXPR_ARITH_SQUARE, ARITH_NUMBER, EXPR_ARITH_SQUARE_END);

        testTokenization("$[1 ]", DOLLAR, EXPR_ARITH_SQUARE, ARITH_NUMBER, WHITESPACE, EXPR_ARITH_SQUARE_END);

        testTokenization("$[1/${a}]", DOLLAR, EXPR_ARITH_SQUARE, ARITH_NUMBER, ARITH_DIV, DOLLAR, LEFT_CURLY, WORD, RIGHT_CURLY, EXPR_ARITH_SQUARE_END);

        //lexable, but bad syntax
        testTokenization("$(([1]))", DOLLAR, EXPR_ARITH, LEFT_SQUARE, ARITH_NUMBER, RIGHT_SQUARE, EXPR_ARITH_END);
    }

    @Test
    public void testArithmeticExpr() throws IOException {
        testTokenization("$((1))", DOLLAR, EXPR_ARITH, ARITH_NUMBER, EXPR_ARITH_END);

        testTokenization("$((1,1))", DOLLAR, EXPR_ARITH, ARITH_NUMBER, COMMA, ARITH_NUMBER, EXPR_ARITH_END);

        testTokenization("$((1/${a}))", DOLLAR, EXPR_ARITH, ARITH_NUMBER, ARITH_DIV, DOLLAR, LEFT_CURLY, WORD, RIGHT_CURLY, EXPR_ARITH_END);

        testTokenization("$((a=1,1))", DOLLAR, EXPR_ARITH, ASSIGNMENT_WORD, EQ, ARITH_NUMBER, COMMA, ARITH_NUMBER, EXPR_ARITH_END);

        testTokenization("$((-1))", DOLLAR, EXPR_ARITH, ARITH_MINUS, ARITH_NUMBER, EXPR_ARITH_END);

        testTokenization("$((--1))", DOLLAR, EXPR_ARITH, ARITH_MINUS, ARITH_MINUS, ARITH_NUMBER, EXPR_ARITH_END);

        testTokenization("$((--a))", DOLLAR, EXPR_ARITH, ARITH_MINUS_MINUS, WORD, EXPR_ARITH_END);

        testTokenization("$((- --a))", DOLLAR, EXPR_ARITH, ARITH_MINUS, WHITESPACE, ARITH_MINUS_MINUS, WORD, EXPR_ARITH_END);

        testTokenization("$((-1 -1))", DOLLAR, EXPR_ARITH, ARITH_MINUS, ARITH_NUMBER, WHITESPACE, ARITH_MINUS, ARITH_NUMBER, EXPR_ARITH_END);

        testTokenization("$((a & b))", DOLLAR, EXPR_ARITH, WORD, WHITESPACE, ARITH_BITWISE_AND, WHITESPACE, WORD, EXPR_ARITH_END);

        testTokenization("$((a && b))", DOLLAR, EXPR_ARITH, WORD, WHITESPACE, AND_AND, WHITESPACE, WORD, EXPR_ARITH_END);

        testTokenization("$((a || b))", DOLLAR, EXPR_ARITH, WORD, WHITESPACE, OR_OR, WHITESPACE, WORD, EXPR_ARITH_END);

        testTokenization("$((!a))", DOLLAR, EXPR_ARITH, ARITH_NEGATE, WORD, EXPR_ARITH_END);

        testTokenization("$((~a))", DOLLAR, EXPR_ARITH, ARITH_BITWISE_NEGATE, WORD, EXPR_ARITH_END);

        testTokenization("$((a>>2))", DOLLAR, EXPR_ARITH, WORD, ARITH_SHIFT_RIGHT, ARITH_NUMBER, EXPR_ARITH_END);

        testTokenization("$((a<<2))", DOLLAR, EXPR_ARITH, WORD, ARITH_SHIFT_LEFT, ARITH_NUMBER, EXPR_ARITH_END);

        testTokenization("$((a|2))", DOLLAR, EXPR_ARITH, WORD, PIPE, ARITH_NUMBER, EXPR_ARITH_END);

        testTokenization("$((a&2))", DOLLAR, EXPR_ARITH, WORD, ARITH_BITWISE_AND, ARITH_NUMBER, EXPR_ARITH_END);

        testTokenization("$((a^2))", DOLLAR, EXPR_ARITH, WORD, ARITH_BITWISE_XOR, ARITH_NUMBER, EXPR_ARITH_END);

        testTokenization("$((a%2))", DOLLAR, EXPR_ARITH, WORD, ARITH_MOD, ARITH_NUMBER, EXPR_ARITH_END);

        testTokenization("$((a-2))", DOLLAR, EXPR_ARITH, WORD, ARITH_MINUS, ARITH_NUMBER, EXPR_ARITH_END);

        testTokenization("$((a--))", DOLLAR, EXPR_ARITH, WORD, ARITH_MINUS_MINUS, EXPR_ARITH_END);

        testTokenization("$((--a))", DOLLAR, EXPR_ARITH, ARITH_MINUS_MINUS, WORD, EXPR_ARITH_END);

        testTokenization("$((a,2))", DOLLAR, EXPR_ARITH, WORD, COMMA, ARITH_NUMBER, EXPR_ARITH_END);

        testTokenization("$((a>2))", DOLLAR, EXPR_ARITH, WORD, ARITH_GT, ARITH_NUMBER, EXPR_ARITH_END);

        testTokenization("$((a > 2))", DOLLAR, EXPR_ARITH, WORD, WHITESPACE, ARITH_GT, WHITESPACE, ARITH_NUMBER, EXPR_ARITH_END);

        testTokenization("$((a>=2))", DOLLAR, EXPR_ARITH, WORD, ARITH_GE, ARITH_NUMBER, EXPR_ARITH_END);
        ...
        testTokenization("$((1+-45))", DOLLAR, EXPR_ARITH, ARITH_NUMBER, ARITH_PLUS, ARITH_MINUS, ARITH_NUMBER, EXPR_ARITH_END);

        testTokenization("$((1+(-45)))", DOLLAR, EXPR_ARITH, ARITH_NUMBER, ARITH_PLUS, LEFT_PAREN, ARITH_MINUS, ARITH_NUMBER, RIGHT_PAREN, EXPR_ARITH_END);

        testTokenization("$((1+---45))", DOLLAR, EXPR_ARITH, ARITH_NUMBER, ARITH_PLUS, ARITH_MINUS, ARITH_MINUS, ARITH_MINUS, ARITH_NUMBER, EXPR_ARITH_END);

        testTokenization("$(((1 << 10)))", DOLLAR, LEFT_PAREN, EXPR_ARITH, ARITH_NUMBER, WHITESPACE, ARITH_SHIFT_LEFT, WHITESPACE, ARITH_NUMBER, EXPR_ARITH_END, RIGHT_PAREN);

        testTokenization("$((1 < \"1\"))", DOLLAR, EXPR_ARITH, ARITH_NUMBER, WHITESPACE, ARITH_LT, WHITESPACE, STRING_BEGIN, STRING_CONTENT, STRING_END, EXPR_ARITH_END);

        testTokenization("$((((1))))", DOLLAR, LEFT_PAREN, EXPR_ARITH, LEFT_PAREN, ARITH_NUMBER, RIGHT_PAREN, EXPR_ARITH_END, RIGHT_PAREN);
    ...
    @Test
    public void testShebang() throws IOException {
    ...
    public void testStrings() throws IOException {
        ...
        testTokenization("\"$((1))\"", STRING_BEGIN, DOLLAR, EXPR_ARITH, ARITH_NUMBER, EXPR_ARITH_END, STRING_END);
        ...
        testTokenization("[ \\${a} ]", EXPR_CONDITIONAL, WORD, LEFT_CURLY, WORD, RIGHT_CURLY, EXPR_CONDITIONAL_END);
        testTokenization("[  ]", EXPR_CONDITIONAL, EXPR_CONDITIONAL_END);
        testTokenization("[ ]", EXPR_CONDITIONAL, EXPR_CONDITIONAL_END);
        testTokenization("[ a  ]", EXPR_CONDITIONAL, WORD, WHITESPACE, EXPR_CONDITIONAL_END);
        testTokenization("[ a | b ]", EXPR_CONDITIONAL, WORD, WHITESPACE, PIPE, WHITESPACE, WORD, EXPR_CONDITIONAL_END);
        testTokenization("[[ a || b ]]", BRACKET_KEYWORD, WORD, WHITESPACE, OR_OR, WHITESPACE, WORD, BRACKET_KEYWORD_END);
    ...
    @Test
    public void testSubshellString() throws IOException {
    ...
    @Test
    public void testSubshellSubstring() throws IOException {
    ...
    @Test
    public void testInternalCommands() throws IOException {
    ...
    public void testExpressions() throws IOException {
        testTokenization("if [ -n \"a\" ]; then a; fi;",
                IF_KEYWORD, WHITESPACE, EXPR_CONDITIONAL, COND_OP, WHITESPACE, STRING_BEGIN, STRING_CONTENT, STRING_END, EXPR_CONDITIONAL_END, SEMI,
                WHITESPACE, THEN_KEYWORD, WHITESPACE, WORD, SEMI, WHITESPACE, FI_KEYWORD, SEMI);

        testTokenization("$((1+2))", DOLLAR, EXPR_ARITH, ARITH_NUMBER, ARITH_PLUS, ARITH_NUMBER, EXPR_ARITH_END);
        testTokenization("((i=$(echo 1)))", EXPR_ARITH, ASSIGNMENT_WORD, EQ, DOLLAR, LEFT_PAREN, WORD, WHITESPACE, INTEGER_LITERAL, RIGHT_PAREN, EXPR_ARITH_END);
        testTokenization("((i=$((1 + 9))))",
                EXPR_ARITH, ASSIGNMENT_WORD, EQ, DOLLAR, EXPR_ARITH, ARITH_NUMBER, WHITESPACE,
                ARITH_PLUS, WHITESPACE, ARITH_NUMBER, EXPR_ARITH_END, EXPR_ARITH_END);

        testTokenization("((1 == 1 ? 0 : 0))",
                EXPR_ARITH, ARITH_NUMBER, WHITESPACE, ARITH_EQ, WHITESPACE, ARITH_NUMBER, WHITESPACE, ARITH_QMARK,
                WHITESPACE, ARITH_NUMBER, WHITESPACE, ARITH_COLON, WHITESPACE, ARITH_NUMBER, EXPR_ARITH_END);

        testTokenization("a=(\na #this is a comment\nb)", ASSIGNMENT_WORD, EQ, LEFT_PAREN, LINE_FEED, WORD, WHITESPACE, COMMENT, LINE_FEED, WORD, RIGHT_PAREN);
    }

    @Test
    public void testSubshell() throws IOException {
        testTokenization("$(echo \"$1\")",
                DOLLAR, LEFT_PAREN, WORD, WHITESPACE, STRING_BEGIN, VARIABLE, STRING_END, RIGHT_PAREN);
        testTokenization("$(($(echo \"$1\")))",
                DOLLAR, EXPR_ARITH, DOLLAR, LEFT_PAREN, WORD, WHITESPACE, STRING_BEGIN, VARIABLE, STRING_END, RIGHT_PAREN, EXPR_ARITH_END);
        testTokenization("`for d in`",
                BACKQUOTE, FOR_KEYWORD, WHITESPACE, WORD, WHITESPACE, WORD, BACKQUOTE);
        testTokenization("[ \"`dd`\" ]",
                EXPR_CONDITIONAL, STRING_BEGIN, BACKQUOTE, WORD, BACKQUOTE, STRING_END, EXPR_CONDITIONAL_END);
    }

    @Test
    public void testNumber() throws IOException {
        testTokenization("123", INTEGER_LITERAL);
        testTokenization("$((123))", DOLLAR, EXPR_ARITH, ARITH_NUMBER, EXPR_ARITH_END);

        testTokenization("123 456", INTEGER_LITERAL, WHITESPACE, INTEGER_LITERAL);
        testTokenization("$((123 234))", DOLLAR, EXPR_ARITH, ARITH_NUMBER, WHITESPACE, ARITH_NUMBER, EXPR_ARITH_END);
    }
    ...
    public void testConditional() throws IOException {
        testTokenization("[ 1 = \"$backgrounded\" ]", EXPR_CONDITIONAL, WORD, WHITESPACE, COND_OP, WHITESPACE, STRING_BEGIN, VARIABLE, STRING_END, EXPR_CONDITIONAL_END);

        testTokenization("[ 1 == 1 ]", EXPR_CONDITIONAL, WORD, WHITESPACE, COND_OP_EQ_EQ, WHITESPACE, WORD, EXPR_CONDITIONAL_END);

        testTokenization("[ 1 =~ 1 ]", EXPR_CONDITIONAL, WORD, WHITESPACE, COND_OP_REGEX, WHITESPACE, WORD, EXPR_CONDITIONAL_END);
    }

    @Test
    public void testBracket() throws IOException {
        testTokenization("[[ -f test.txt ]]", BRACKET_KEYWORD, COND_OP, WHITESPACE, WORD, BRACKET_KEYWORD_END);
        testTokenization(" ]]", WHITESPACE, WORD);
        testTokenization("  ]]", WHITESPACE, WHITESPACE, WORD);
        testTokenization("[[  -f test.txt   ]]", BRACKET_KEYWORD, WHITESPACE, COND_OP, WHITESPACE, WORD, WHITESPACE, WHITESPACE, BRACKET_KEYWORD_END);
        testTokenization("[[ !(a) ]]", BRACKET_KEYWORD, COND_OP_NOT, LEFT_PAREN, WORD, RIGHT_PAREN, BRACKET_KEYWORD_END);

        testTokenization("[[ a && b ]]", BRACKET_KEYWORD, WORD, WHITESPACE, AND_AND, WHITESPACE, WORD, BRACKET_KEYWORD_END);
        testTokenization("[[ a || b ]]", BRACKET_KEYWORD, WORD, WHITESPACE, OR_OR, WHITESPACE, WORD, BRACKET_KEYWORD_END);

        testTokenization("[[ -z \"\" ]]", BRACKET_KEYWORD, COND_OP, WHITESPACE, STRING_BEGIN, STRING_END, BRACKET_KEYWORD_END);

        testTokenization("[[ a == b ]]", BRACKET_KEYWORD, WORD, WHITESPACE, COND_OP_EQ_EQ, WHITESPACE, WORD, BRACKET_KEYWORD_END);
        testTokenization("[[ a =~ b ]]", BRACKET_KEYWORD, WORD, WHITESPACE, COND_OP_REGEX, WHITESPACE, WORD, BRACKET_KEYWORD_END);
    }

    @Test
    public void testParameterSubstitution() throws IOException {
    ...
    @Test
    public void testWeirdStuff1() throws IOException {
    ...
    @Test
    public void testCaseWhitespacePattern() throws IOException {
    ...
    @Test
    public void testNestedCase() throws IOException {
    ...
    @Test
    public void testBackquote1() throws IOException {
    ...
    @Test
    public void testCasePattern() throws IOException {
    ...
    @Test
    public void testAssignmentList() throws IOException {
    ...
    public void testEval() throws IOException {
        testTokenization("eval [ \"a\" ]",
                WORD, WHITESPACE, EXPR_CONDITIONAL, STRING_BEGIN, STRING_CONTENT, STRING_END, EXPR_CONDITIONAL_END);
        ...
        testTokenization("case a in a) echo [ \"a\" ];; esac",
                ...
                RIGHT_PAREN, WHITESPACE, WORD, WHITESPACE, EXPR_CONDITIONAL, STRING_BEGIN, STRING_CONTENT, STRING_END, EXPR_CONDITIONAL_END, CASE_END, WHITESPACE, ESAC_KEYWORD);
    }

    @Test
    public void testNestedStatements() throws IOException {
        ...
        testTokenization("for ((a=1;a;))",
                FOR_KEYWORD, WHITESPACE, EXPR_ARITH, ASSIGNMENT_WORD, EQ, ARITH_NUMBER, SEMI,
                WORD, SEMI, EXPR_ARITH_END);

        testTokenization("for ((a=1;a<2;a=a+1))",
                FOR_KEYWORD, WHITESPACE, EXPR_ARITH, ASSIGNMENT_WORD, EQ, ARITH_NUMBER, SEMI,
                WORD, ARITH_LT, ARITH_NUMBER, SEMI, ASSIGNMENT_WORD, EQ, WORD, ARITH_PLUS, ARITH_NUMBER, EXPR_ARITH_END);
    ...
    @Test
    public void testV4Lexing() throws IOException {
        //new &>> redirect token
    ...
    @Test
    public void testParamExpansionNested() throws IOException {
        //${a${a}}
    ...
    @Test
    public void testParamExpansion() throws IOException {
        testTokenization("${a}", DOLLAR, LEFT_CURLY, WORD, RIGHT_CURLY);
        ...
        testTokenization("${a-`$[1]`}", DOLLAR, LEFT_CURLY, WORD, PARAM_EXPANSION_OP_MINUS, BACKQUOTE, DOLLAR, EXPR_ARITH_SQUARE, ARITH_NUMBER, EXPR_ARITH_SQUARE_END, BACKQUOTE, RIGHT_CURLY);
    }

    @Test
    public void testArithmeticLiterals() throws IOException {
        testTokenization("$((123))", DOLLAR, EXPR_ARITH, ARITH_NUMBER, EXPR_ARITH_END);

        testTokenization("$((0x123))", DOLLAR, EXPR_ARITH, ARITH_HEX_NUMBER, EXPR_ARITH_END);
        testTokenization("$((0xA))", DOLLAR, EXPR_ARITH, ARITH_HEX_NUMBER, EXPR_ARITH_END);
        testTokenization("$((0xAf))", DOLLAR, EXPR_ARITH, ARITH_HEX_NUMBER, EXPR_ARITH_END);
        testTokenization("$((-0xAf))", DOLLAR, EXPR_ARITH, ARITH_MINUS, ARITH_HEX_NUMBER, EXPR_ARITH_END);
        testTokenization("$((--0xAf))", DOLLAR, EXPR_ARITH, ARITH_MINUS, ARITH_MINUS, ARITH_HEX_NUMBER, EXPR_ARITH_END);
        testTokenization("$((+0xAf))", DOLLAR, EXPR_ARITH, ARITH_PLUS, ARITH_HEX_NUMBER, EXPR_ARITH_END);

        testTokenization("$((10#1))", DOLLAR, EXPR_ARITH, ARITH_NUMBER, ARITH_BASE_CHAR, ARITH_NUMBER, EXPR_ARITH_END);
        testTokenization("$((10#100))", DOLLAR, EXPR_ARITH, ARITH_NUMBER, ARITH_BASE_CHAR, ARITH_NUMBER, EXPR_ARITH_END);
        testTokenization("$((-10#100))", DOLLAR, EXPR_ARITH, ARITH_MINUS, ARITH_NUMBER, ARITH_BASE_CHAR, ARITH_NUMBER, EXPR_ARITH_END);
        testTokenization("$((+10#100))", DOLLAR, EXPR_ARITH, ARITH_PLUS, ARITH_NUMBER, ARITH_BASE_CHAR, ARITH_NUMBER, EXPR_ARITH_END);

        testTokenization("$((0123))", DOLLAR, EXPR_ARITH, ARITH_OCTAL_NUMBER, EXPR_ARITH_END);
        testTokenization("$((-0123))", DOLLAR, EXPR_ARITH, ARITH_MINUS, ARITH_OCTAL_NUMBER, EXPR_ARITH_END);

        //also afe is not valid here we expect it to lex because we check the base in
        //an inspection
        testTokenization("$((10#100afe))", DOLLAR, EXPR_ARITH, ARITH_NUMBER, ARITH_BASE_CHAR, ARITH_NUMBER, WORD, EXPR_ARITH_END);

        testTokenization("$((12#D))", DOLLAR, EXPR_ARITH, ARITH_NUMBER, ARITH_BASE_CHAR, WORD, EXPR_ARITH_END);

        testTokenization("$((35#abcdefghijkl))", DOLLAR, EXPR_ARITH, ARITH_NUMBER, ARITH_BASE_CHAR, WORD, EXPR_ARITH_END);
    }
    ...
    @Test
    public void testSubshellExpr() throws IOException {
    ...
    public void testIssue201() throws IOException {
        testTokenization("((!foo))", EXPR_ARITH, ARITH_NEGATE, WORD, EXPR_ARITH_END);
    }
...
//        testTokenization("cat <<END&&test\nEND", WORD, WHITESPACE, HEREDOC_MARKER_TAG, HEREDOC_MARKER_START, AND_AND, WHITESPACE, WORD, LINE_FEED, HEREDOC_MARKER_END);
        ...
        testTokenization("{\n" +
                        ...
                        "EOF2", LEFT_CURLY, LINE_FEED, HEREDOC_MARKER_TAG, HEREDOC_MARKER_START, WHITESPACE, HEREDOC_MARKER_TAG, HEREDOC_MARKER_START, LINE_FEED,
                HEREDOC_MARKER_END, LINE_FEED,
                DOLLAR, EXPR_ARITH, WORD, EXPR_ARITH_END, HEREDOC_CONTENT,
                HEREDOC_MARKER_END
        );
        ...
        testTokenization("{\n" +
                        ...
                        "EOF2", LEFT_CURLY, LINE_FEED, HEREDOC_MARKER_TAG, HEREDOC_MARKER_START, WHITESPACE, HEREDOC_MARKER_TAG, HEREDOC_MARKER_START, LINE_FEED,
                HEREDOC_MARKER_END, LINE_FEED,
                DOLLAR, EXPR_ARITH_SQUARE, WORD, EXPR_ARITH_SQUARE_END, HEREDOC_CONTENT,
                HEREDOC_MARKER_END
        );
    }

    @Test
    public void testMultilineHeredoc() throws IOException {
    ...
    @Test
    public void testIssue199() throws IOException {
        testTokenization("$( ((count != 1)) && echo)", DOLLAR, LEFT_PAREN, WHITESPACE, EXPR_ARITH, WORD, WHITESPACE, ARITH_NE, WHITESPACE, ARITH_NUMBER, EXPR_ARITH_END, WHITESPACE, AND_AND, WHITESPACE, WORD, RIGHT_PAREN);
        testTokenization("$(((count != 1)) && echo)", DOLLAR, LEFT_PAREN, EXPR_ARITH, WORD, WHITESPACE, ARITH_NE, WHITESPACE, ARITH_NUMBER, EXPR_ARITH_END, WHITESPACE, AND_AND, WHITESPACE, WORD, RIGHT_PAREN);
        ...
        //BashSupport doesn't
        testTokenization("(((1==1)))", LEFT_PAREN, EXPR_ARITH, ARITH_NUMBER, ARITH_EQ, ARITH_NUMBER, EXPR_ARITH_END, RIGHT_PAREN);
    ...
    @Test
    public void testIssue242() throws IOException {
    ...
    @Test
    public void testIssue243() throws IOException {
    ...
    @Test
    public void testIssue266() throws IOException {
        testTokenization("${#}", DOLLAR, LEFT_CURLY, PARAM_EXPANSION_OP_HASH, RIGHT_CURLY);
    }

    @Test
    public void testIssue270() throws IOException {
    ...
    @Test
    public void testIssue272() throws IOException {
    ...
    @Test
    public void testIssue300() throws IOException {
        testTokenization("case x in\nabc${a}) ;; esac",
    ...
    @Test
    public void testIssue303() throws IOException {
    ...
    @Test
    public void testIssue308() throws IOException {
        testTokenization("[[ $# == \"x\" ]]", BRACKET_KEYWORD, VARIABLE, WHITESPACE, COND_OP_EQ_EQ, WHITESPACE, STRING_BEGIN, STRING_CONTENT, STRING_END, BRACKET_KEYWORD_END);

        testTokenization("[[ ( $# == \"x\" ) ]]", BRACKET_KEYWORD, LEFT_PAREN, WHITESPACE, VARIABLE, WHITESPACE, COND_OP_EQ_EQ, WHITESPACE, STRING_BEGIN, STRING_CONTENT, STRING_END, WHITESPACE, RIGHT_PAREN, BRACKET_KEYWORD_END);

        testTokenization("[[ ( $# == \"x\" ) || -f \"x\" || 123==123 ]]", BRACKET_KEYWORD, LEFT_PAREN, WHITESPACE, VARIABLE, WHITESPACE, COND_OP_EQ_EQ, WHITESPACE, STRING_BEGIN, STRING_CONTENT, STRING_END, WHITESPACE, RIGHT_PAREN, WHITESPACE, OR_OR, WHITESPACE, COND_OP, WHITESPACE, STRING_BEGIN, STRING_CONTENT, STRING_END, WHITESPACE, OR_OR, WHITESPACE, WORD, COND_OP_EQ_EQ, WORD, BRACKET_KEYWORD_END);
    }

    @Test
    public void testIssue89() throws IOException {
    ...
    public void testIssue320() throws IOException {
        testTokenization("(( a[0] ))", EXPR_ARITH, WHITESPACE, ASSIGNMENT_WORD, LEFT_SQUARE, ARITH_NUMBER, RIGHT_SQUARE, WHITESPACE, EXPR_ARITH_END);
        testTokenization("(( A[0] ))", EXPR_ARITH, WHITESPACE, ASSIGNMENT_WORD, LEFT_SQUARE, ARITH_NUMBER, RIGHT_SQUARE, WHITESPACE, EXPR_ARITH_END);

        testTokenization("(( a[0x0] ))", EXPR_ARITH, WHITESPACE, ASSIGNMENT_WORD, LEFT_SQUARE, ARITH_HEX_NUMBER, RIGHT_SQUARE, WHITESPACE, EXPR_ARITH_END);
        testTokenization("(( A[0x0] ))", EXPR_ARITH, WHITESPACE, ASSIGNMENT_WORD, LEFT_SQUARE, ARITH_HEX_NUMBER, RIGHT_SQUARE, WHITESPACE, EXPR_ARITH_END);

        testTokenization("(( a[a[b]] ))", EXPR_ARITH, WHITESPACE, ASSIGNMENT_WORD, LEFT_SQUARE, ASSIGNMENT_WORD, LEFT_SQUARE, WORD, RIGHT_SQUARE, RIGHT_SQUARE, WHITESPACE, EXPR_ARITH_END);
        testTokenization("(( a[a[0]] ))", EXPR_ARITH, WHITESPACE, ASSIGNMENT_WORD, LEFT_SQUARE, ASSIGNMENT_WORD, LEFT_SQUARE, ARITH_NUMBER, RIGHT_SQUARE, RIGHT_SQUARE, WHITESPACE, EXPR_ARITH_END);
    ...
    @Test
    public void testIssue327() throws IOException {
    ...
    @Test
    public void testIssue343() throws IOException {
        testTokenization("{\n" +
                        "<<EOF <<EOF2\n" +
                        "EOF\n" +
                        "${}\n" +
    ...
    @Test
    public void testTrapLexing() throws IOException {
    ...
    @Test
    public void testEvalLexing() throws IOException {
        testTokenization("$a=$a", VARIABLE, EQ, VARIABLE);
    }

    @Test
    public void testIssue376() throws IOException {
        testTokenization("$(echo 2>&1)", DOLLAR, LEFT_PAREN, WORD, WHITESPACE, INTEGER_LITERAL, GREATER_THAN, FILEDESCRIPTOR, RIGHT_PAREN);
        testTokenization("[[ $(echo 2>&1) ]]", BRACKET_KEYWORD, DOLLAR, LEFT_PAREN, WORD, WHITESPACE, INTEGER_LITERAL, GREATER_THAN, FILEDESCRIPTOR, RIGHT_PAREN, BRACKET_KEYWORD_END);
    }

    @Test
    public void testIssue367() throws IOException {
        //invalid command semantic, but lexing needs to work
        testTokenization("[ (echo a) ]", EXPR_CONDITIONAL, LEFT_PAREN, WORD, WHITESPACE, WORD, RIGHT_PAREN, EXPR_CONDITIONAL_END);

        testTokenization("[[ $(< $1) ]]", BRACKET_KEYWORD, DOLLAR, LEFT_PAREN, LESS_THAN, WHITESPACE, VARIABLE, RIGHT_PAREN, BRACKET_KEYWORD_END);

        testTokenization("[[ $((1+1)) ]]", BRACKET_KEYWORD, DOLLAR, EXPR_ARITH, ARITH_NUMBER, ARITH_PLUS, ARITH_NUMBER, EXPR_ARITH_END, BRACKET_KEYWORD_END);
    }

    @Test
    public void testIssue418() throws IOException {
    ...
    public void testHereString() throws IOException {
        ...
        testTokenization("a <<< [$((1))]", WORD, WHITESPACE, REDIRECT_HERE_STRING, WHITESPACE, WORD, DOLLAR, EXPR_ARITH, ARITH_NUMBER, EXPR_ARITH_END, WORD);
    ...
    @Test
    public void testIssue358() throws IOException {
    ...
    @Test
    public void testIssue398() throws IOException {
        //the problem with #398 was, that the lexer had a bad rule to leave unmatched characters and not return BAD_CHARACTER for all states at the end
        testTokenization("$(${)", DOLLAR, LEFT_PAREN, DOLLAR, LEFT_CURLY, BAD_CHARACTER);
    }

    @Test
    public void testIssue426() throws IOException {
    ...
    @Test
    public void testIssue431() throws IOException {
        //the problem with #398 was, that the lexer had a bad rule to leave unmatched characters and not return BAD_CHARACTER for all states at the end
        testTokenization("$((x|=5))", DOLLAR, EXPR_ARITH, WORD, ARITH_ASS_BIT_OR, ARITH_NUMBER, EXPR_ARITH_END);
        testTokenization("$((x&=5))", DOLLAR, EXPR_ARITH, WORD, ARITH_ASS_BIT_AND, ARITH_NUMBER, EXPR_ARITH_END);
        testTokenization("$((x^=5))", DOLLAR, EXPR_ARITH, WORD, ARITH_ASS_BIT_XOR, ARITH_NUMBER, EXPR_ARITH_END);
    }

    @Test
    public void testIssue419() throws IOException {
        ...
        testTokenization("issues=($((1+1)))", ASSIGNMENT_WORD, EQ, LEFT_PAREN, DOLLAR, EXPR_ARITH, ARITH_NUMBER, ARITH_PLUS, ARITH_NUMBER, EXPR_ARITH_END, RIGHT_PAREN);
    }

    @Test
    public void testIssue412() throws IOException {
        testTokenization("[[ (a =~ \"b\") ]]", BRACKET_KEYWORD, LEFT_PAREN, WORD, WHITESPACE, COND_OP_REGEX, WHITESPACE, STRING_BEGIN, STRING_CONTENT, STRING_END, RIGHT_PAREN, BRACKET_KEYWORD_END);
    }

    @Test
    public void testIssue401() throws IOException {
    ...
    @Test
    public void testIssue457() throws IOException {
        /*
        a="a\
        b"
        $a
    ...
    @Test
    public void testIssue469() throws IOException {
    ...
    @Test
    public void testIssue473() throws IOException {
        // `cat <<EOF
        // X
        // EOF`
    ...
    private void testNoErrors(String code) throws IOException {
        BashLexer lexer = new BashLexer(BashVersion.Bash_v4, new StringReader(code));
    ...
    private void testTokenization(String code, TokenType... expectedTokens) throws IOException {
        testTokenization(BashVersion.Bash_v3, code, expectedTokens);
    }

    private void testTokenization(boolean isBash4, String code, TokenType... expectedTokens) throws IOException {
        BashLexer lexer = new BashLexer(isBash4, new StringReader(code));

        int i = 1;
        for (TokenType expectedToken : expectedTokens) {
            TokenType tokenType = lexer.next().type;
        ...
        boolean noTokensLeft = lexer.next() == null;
        if (!noTokensLeft) {
            List<TokenType> tokens = new LinkedList<>();
            while (lexer.getToken() != null) {
                tokens.add(lexer.getToken().type);
                lexer.next();
            }

            Assert.assertTrue("Lexer has tokens left: " + tokens, noTokensLeft);
        }
    }


    private interface BashVersion {
        boolean Bash_v3 = false;
        boolean Bash_v4 = true;
    }
}
